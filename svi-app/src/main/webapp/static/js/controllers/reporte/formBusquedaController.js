angular.module(appTeclo).controller('formBusquedaController',
		function($scope,reporteService,growl,$timeout,$filter,showAlert,reporte,$location,$rootScope) {
	...
	$scope.gridOptions = {
		...
		$scope.regresar = function (){
			...
			$rootScope.listaValido != undefined ? $rootScope.listaValido.isListaDoble = false: "";
			
			$location.path("/reporteDinamico");
		};
});