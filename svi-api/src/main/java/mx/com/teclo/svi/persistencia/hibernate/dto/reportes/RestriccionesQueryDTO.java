...
public class RestriccionesQueryDTO implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "SQAQ041D", sequenceName="SQAQ041D_AR_RESTRIC_QUERY", allocationSize=1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SQAQ041D")
